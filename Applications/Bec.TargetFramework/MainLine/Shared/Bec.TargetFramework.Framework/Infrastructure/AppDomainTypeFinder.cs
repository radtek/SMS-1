...
{
    /// <summary>
    /// A class that finds types needed by TargetFramework by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether TargetFramework should iterate assemblies in the app domain when loading TargetFramework types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that TargetFramework assemblies arn't investigated (e.g. by not including something like "^TargetFramework|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the TargetFramework factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into TargetFramework.
        /// </returns>
