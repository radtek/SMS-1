...
namespace Bec.TargetFramework.Entities
{
    ...
    public partial class RoleDTO
    {
        ...
        [DataMember]
        public List<SMHPageDTO> SMHPages { get; set; }

        [DataMember]
        public List<RoleHierarchyDTO> RoleHierarchies { get; set; }
