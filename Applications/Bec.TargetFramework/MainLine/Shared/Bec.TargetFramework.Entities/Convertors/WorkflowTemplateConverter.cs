    ...
    public static partial class WorkflowTemplateConverter
    {
        ...
        public static WorkflowTemplateDTO ToDtoWithRelated(this Bec.TargetFramework.Data.WorkflowTemplate source, int level)
        {
            ...
            if (level > 0) {
              ...
              target.WorkflowMainCompleteConditionTemplates = source.WorkflowMainCompleteConditionTemplates.ToDtosWithRelated(level - 1);
              target.WorkflowMainStartConditionTemplates = source.WorkflowMainStartConditionTemplates.ToDtosWithRelated(level - 1);
              target.WorkflowMainExecuteCommandTemplates = source.WorkflowMainExecuteCommandTemplates.ToDtosWithRelated(level - 1);
              target.WorkflowMainPostCommandTemplates = source.WorkflowMainPostCommandTemplates.ToDtosWithRelated(level - 1);
              target.WorkflowMainPreCommandTemplates = source.WorkflowMainPreCommandTemplates.ToDtosWithRelated(level - 1);
              ...
              target.WorkflowConditionTemplates = source.WorkflowConditionTemplates.ToDtosWithRelated(level - 1);
