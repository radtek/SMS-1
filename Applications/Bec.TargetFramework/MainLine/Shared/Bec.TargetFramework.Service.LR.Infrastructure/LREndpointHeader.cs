...
namespace Bec.TargetFramework.Service.LR.Infrastructure
{
    ...
    public class LREndpointHeader : IClientMessageInspector
    {
        ...
        public LREndpointHeader(string username, string password)
        {
            m_Username = username;
            m_Password = password;
        }
...
// Create the i18nHeader with the locale settings.
        ...
        private MessageHeader CreateWsseSecurityHeader()
        {
            ...
            return MessageHeader.CreateHeader("Security",
                "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd", doc.DocumentElement);
        }
    ...
    public class LREndpointBehavior : Attribute, IEndpointBehavior, IOperationBehavior, IContractBehavior
    {
        #region Member Variables
        ...
        public LREndpointBehavior(string username, string password)
        {
            m_Username = username;
            m_Password = password;
        ...
        {
            clientRuntime.MessageInspectors.Add(new LREndpointHeader(m_Username, m_Password));
        }
        ...
        {
            clientOperation.Parent.MessageInspectors.Add(new LREndpointHeader(m_Username, m_Password));
        }
