...
using Bec.TargetFramework.Data.Infrastructure.Context.Initializers;
...
namespace Bec.TargetFramework.Data.Infrastructure.Context
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        public virtual void SetDatabaseInitializer()
        {
            ...
            var initializer = new CreateTablesIfNotExist<TargetFrameworkEntities>(tablesToValidate, customCommands.ToArray());
