...
namespace Bec.TargetFramework.Data.Infrastructure
{
    ...
    public abstract class LinqCompoundKeyRepositoryBase<T> : CompoundKeyRepositoryBase<T> where T : class
    {
        ...
        protected override async Task<T> GetQueryAsync(params object[] keys)
        {
            return await FindQueryAsync(ByPrimaryKeySpecification(keys));
        }
    ...
    public abstract class LinqCompoundKeyRepositoryBase<T, TKey, TKey2> : CompoundKeyRepositoryBase<T, TKey, TKey2> where T : class
    {
        ...
        protected override async Task<T> GetQueryAsync(TKey key, TKey2 key2)
        {
            return await FindQueryAsync(ByPrimaryKeySpecification(key, key2));
        }
    ...
    public abstract class LinqCompoundKeyRepositoryBase<T, TKey, TKey2, TKey3> : CompoundKeyRepositoryBase<T, TKey, TKey2, TKey3> where T : class
    {
        ...
        protected override async Task<T> GetQueryAsync(TKey key, TKey2 key2, TKey3 key3)
        {
            return await FindQueryAsync(ByPrimaryKeySpecification(key, key2, key3));
        }
