...
namespace Bec.TargetFramework.Data.Infrastructure
{
    ...
    public class ConfigurationBasedRepository<T, TKey> : IRepository<T, TKey> where T : class, new()
    {
        ...
        public async System.Threading.Tasks.Task<T> GetAsync(TKey key)
        {
            return await Repository.GetAsync(key);
        }

        public async System.Threading.Tasks.Task<TResult> GetAsync<TResult>(TKey key, Expression<Func<T, TResult>> selector)
        {
            return await Repository.GetAsync(key,selector);
        }

        public async System.Threading.Tasks.Task<bool> ExistsAsync(TKey key)
        {
            return await Repository.ExistsAsync(key);
        }

        public async System.Threading.Tasks.Task<bool> TryGetAsync(TKey key)
        {
            return await Repository.TryGetAsync(key);
        }

        public async System.Threading.Tasks.Task<bool> TryGetAsync<TResult>(TKey key, Expression<Func<T, TResult>> selector)
        {
            return await Repository.TryGetAsync(key, selector);
        }
        ...
        public List<EntityError> EntityErrors
        {
            get
            {
                return Repository.EntityErrors;
            }
            set
            {
                Repository.EntityErrors = value;
            }
        }
        ...
        public bool HasEntityErrors
        {
            get
            {
                return Repository.HasEntityErrors;
            }
        }
        ...
        public bool IsInScope
        {
            get
            {
                return Repository.IsInScope;
            }
            set
            {
                Repository.IsInScope = value;
            }
        }
        ...
        public bool TurnOffTracking
        {
            get
            {
                return Repository.TurnOffTracking;
            }
            set
            {
                Repository.TurnOffTracking = value;
            }
        }
    }
}
