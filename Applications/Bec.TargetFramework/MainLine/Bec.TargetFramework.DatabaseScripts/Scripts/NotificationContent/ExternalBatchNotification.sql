...
VALUES (
  NcTID,
  NcTVN,
  'ExternalBatchNotification',
  'External Batch Notification of an Internal Notification',
  4989,
  4992,
  'You have a new SMS Notifications' ,
  'You have a new SMS Notifications',
  '0092',
  'Bec.TargetFramework.SB.Notifications.Mutators.ExternalBatchNotificationMutator, Bec.TargetFramework.SB.Notifications',
  false
);
...
VALUES (
  ...
  'Bec.TargetFramework.Entities.NotificationCountDTO, Bec.TargetFramework.Entities',
  'NotificationCountDTO',
  'Bec.TargetFramework.Entities',
  'Bec.TargetFramework.Entities',
  true,
...
VALUES (
  NcResID,
  'ExternalBatch Notification',
  'Exernal Batch Notification Resource',
  true,
  false,
  null
);
