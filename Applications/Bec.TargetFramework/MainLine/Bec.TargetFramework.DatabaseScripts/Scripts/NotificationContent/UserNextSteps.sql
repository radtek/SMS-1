...
VALUES (
  NcTID,
  NcTVN,
  'ConveyancyEmployeeNextSteps',
  'Conveyancy Employee Next Steps Notification',
  4990,
  4993,
  'SMS Next Steps' ,
  'SMS Next Steps',
  '9998',
  'Bec.TargetFramework.SB.Notifications.Mutators.ConveyancingEmployeeNextStepsMutator, Bec.TargetFramework.SB.Notifications',
  false
);
...
VALUES (
  NcResID,
  'ConveyancingEmployeeNextSteps Notification',
  'Conveyancing Employee Next Steps Resource',
  true,
  false,
  null
);
