...
VALUES (
  ...
  NcTVN,
  'ColpRegistration',
  'Colp Registration Notification',
  4989,
  4992,
  'Safe Move Scheme Registration Request {RegistrationDTO.FirmTradingName},{RegistrationDTO.FirmRegisteredName}' ,
  'Safe Move Scheme Registration Request {RegistrationDTO.FirmTradingName},{RegistrationDTO.FirmRegisteredName}',
  '0001',
  'Bec.TargetFramework.SB.Notifications.Mutators.ColpRegistrationMutator, Bec.TargetFramework.SB.Notifications',
  false
);
...
VALUES (
  NcResID,
  'ColpRegistration Notification',
  'Colp Registration Resource',
  true,
  false,
  null
);
