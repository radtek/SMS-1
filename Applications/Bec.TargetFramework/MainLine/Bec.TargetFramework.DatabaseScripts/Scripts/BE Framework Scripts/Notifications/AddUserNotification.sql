    ...
    <Page1 Ref="4" type="Page" isKey="true">
      ...
      <Components isList="true" count="1">
        <TextContent Ref="5" type="Text" isKey="true">
          ...
          <Parent isRef="4" />
          <Text>
			&lt;p&gt;  Dear {AddNewCompanyAndAdministratorDTO.Salutation} {AddNewCompanyAndAdministratorDTO.LastName},  &lt;/p&gt;  &lt;p&gt;
			...
			Please contact {AddNewCompanyAndAdministratorDTO.InviterOrganisationName} if you have any queries regarding this email.  &lt;/p&gt;  &lt;p&gt;
			Kind regards,  &lt;/p&gt;  &lt;p&gt;
			The {AddNewCompanyAndAdministratorDTO.ProductName} team  &lt;/p&gt;
		  </Text>
