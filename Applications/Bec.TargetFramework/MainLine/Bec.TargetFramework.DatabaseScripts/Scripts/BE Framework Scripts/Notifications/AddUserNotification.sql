    ...
    <Page1 Ref="4" type="Page" isKey="true">
      ...
      <Components isList="true" count="1">
        <TextContent Ref="5" type="Text" isKey="true">
          ...
          <Page isRef="4" />
          <Parent isRef="4" />
          <Text>&lt;p&gt;  Dear {AddNewCompanyAndAdministratorDTO.Salutation} {AddNewCompanyAndAdministratorDTO.LastName},  &lt;/p&gt;  &lt;p&gt;  {AddNewCompanyAndAdministratorDTO.InviterSalutation} {AddNewCompanyAndAdministratorDTO.InviterFirstName} {AddNewCompanyAndAdministratorDTO.InviterLastName} from {AddNewCompanyAndAdministratorDTO.InviterOrganisationName} has asked you to login to the Safe Move Scheme to protect you against property fraud.  &lt;/p&gt;  &lt;p&gt;  Please go to {AddNewCompanyAndAdministratorDTO.WebsiteURL} and login using the temporary details below:  &lt;/p&gt;  &lt;p&gt;  Username: {AddNewCompanyAndAdministratorDTO.Username}&lt;br/&gt;Password: {AddNewCompanyAndAdministratorDTO.Password}&lt;/p&gt;  &lt;p&gt;  Please note that these are temporary login details to enable you to register and create your own secure login details. These account details will expire after 7 days.  &lt;/p&gt;  &lt;p&gt;  Please contact {AddNewCompanyAndAdministratorDTO.InviterOrganisationName} if you have any queries regarding this email.  &lt;/p&gt;  &lt;p&gt;  Kind regards,  &lt;/p&gt;  &lt;p&gt;  The {AddNewCompanyAndAdministratorDTO.ProductName} team  &lt;/p&gt;</Text>
