...
-- Add Module link for Admin Module
INSERT INTO
...
VALUES (
  DoTemplateID,
  (select "ModuleTemplateID" from "ModuleTemplate" where "Name" = 'Administration Module' limit 1),
  (select "ModuleTemplateVersionNumber" from "ModuleTemplate" where "Name" = 'Administration Module' limit 1),
  null,
  true,
  false,
  DoVersionNumber
