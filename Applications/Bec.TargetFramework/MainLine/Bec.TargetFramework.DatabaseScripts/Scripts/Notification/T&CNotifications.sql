...
VALUES (
  ...
  1,
  '9e8d4076-2139-11e4-8474-3ff6242f5224',
  '4fb312fe-489f-11e4-8f39-5f438902bf9f',
  1,
  true,
  false,
...
FROM
  ...
  left outer join "NotificationConstruct" nc
    ...
    and nc."NotificationConstructTemplateVersionNumber" = ngt."NotificationConstructTemplateVersion"
