...
set "IsDefault" = true
from "Role" r 
where r."RoleID" = a."RoleID" and r."RoleName" in ('Organisation Employee', 'User');
...
update "OrganisationRole" set "IsDefault" = true where "RoleName" in ('Organisation Employee', 'User');
