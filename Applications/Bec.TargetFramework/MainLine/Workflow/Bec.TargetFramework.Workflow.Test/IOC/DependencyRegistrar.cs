...
namespace BEC.TargetFramework.Workflow.Test.IOC
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            RegisterService<IWorkflowProcessService>(builder, BuildBaseUrlForWorkflowServices("WorkflowProcessService"));
            RegisterService<INotificationLogic>(builder, BuildBaseUrlForServices("NotificationLogicService"));
            RegisterService<IExperianIDCheckLogic>(builder, BuildBaseUrlForServices("ExperianIDCheckLogicService"));
            ...
            RegisterService<IFileProcessService>(builder, BuildBaseUrlForFileServices("FileProcessService"));
        ...
        private string BuildBaseUrlForFileServices(string serviceName)
        {
            string baseUrl = ConfigurationManager.AppSettings["FileServiceBaseURL"];
