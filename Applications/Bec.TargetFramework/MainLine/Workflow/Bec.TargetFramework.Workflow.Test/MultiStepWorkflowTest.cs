...
namespace Bec.TargetFramework.Workflow.Test
{
    public class MultiStepWorkflowTest
    {
        ...
        private void CreateWorkflowComponents()
        {
            ...
            workflowComponents.Add(new SubtractWorkflowAction
            {
                ID = Guid.NewGuid(),
                Name = "A2",
                ParentTransistion = transistion
            ...
            workflowComponents.Add(new LessThanWorkflowDecision
            {
                ID = Guid.NewGuid(),
                Name = "D2",
                ParentTransistion = transistion,
                SuccessComponents = workflowComponents.Where(it => it.Name.Equals("A3")).ToList(),
