...
{
    public class TwoStageWorkflowTest
    {
        ...
        private void CreateWorkflowComponents()
        {
            ...
            workflowComponents.Add(new GreaterThanWorkflowDecision
            {
                ...
                Name = "D1",
                ParentTransistion = transistion,
                SuccessComponents = workflowComponents.Where(it => it.Name.Equals("A2") || it.Name.Equals("A3")).ToList(),
                FailureComponents = workflowComponents.Where(it => it.Name.Equals("A1")).ToList()
            });

            workflowComponents.Add(new Is50WorkflowDecision
            {
                ID = Guid.NewGuid(),
                Name = "D2",
                ParentTransistion = transistion,
                SuccessComponents = workflowComponents.Where(it => it.Name.Equals("A4")).ToList(),
                FailureComponents = workflowComponents.Where(it => it.Name.Equals("A2")).ToList()
            });
            ...
            workflowComponents.Add(new Is100WorkflowDecision
            {
                ...
                Name = "D3",
                ParentTransistion = transistion,
                SuccessComponents = workflowComponents.Where(it => it.Name.Equals("A5")).ToList(),
                FailureComponents = workflowComponents.Where(it => it.Name.Equals("A2")).ToList()
            });
        }
    }
