...
{
    class FirmProductWorkflowAction : WorkflowActionBase
    {
        public override bool PerformExecuteCommands()
        {
            ...
            try
            {
                ...
                HasUserPerformed = this.Data.ContainsKey("FirmProductClicked") && this.Data["FirmProductClicked"].Equals("true") ? true : false;
            }
            catch (Exception ex)
            {
