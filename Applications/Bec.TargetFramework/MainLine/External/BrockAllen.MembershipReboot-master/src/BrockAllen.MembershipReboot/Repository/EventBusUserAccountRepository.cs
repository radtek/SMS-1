...
namespace BrockAllen.MembershipReboot
{
        ...
        where TAccount : UserAccount
    {
        ...
        public TAccount GetByEmailNotID(string email, Guid id)
        {
            return inner.GetByEmailNotID(email, id);
        }
        ...
        public TAccount GetByEmail(string email)
        {
            return inner.GetByEmail(email);
        }
    }
}
