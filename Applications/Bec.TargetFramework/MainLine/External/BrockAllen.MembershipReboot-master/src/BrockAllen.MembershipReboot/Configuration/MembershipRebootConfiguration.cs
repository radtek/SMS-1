...
namespace BrockAllen.MembershipReboot
{
        ...
        where TAccount : UserAccount
    {
        ...
        public MembershipRebootConfiguration(SecuritySettings securitySettings)
        {
            ...
            this.forgottenUsernameLockoutFailedAttempts = securitySettings.forgottenUsernameLockoutFailedAttempts;
            this.forgottenUsernameLockoutDuration = securitySettings.forgottenUsernameLockoutDuration;
            this.forgottenPasswordLockoutFailedAttempts = securitySettings.forgottenPasswordLockoutFailedAttempts;
            this.forgottenPasswordLockoutDuration = securitySettings.forgottenPasswordLockoutDuration;
        ...
        public int forgottenUsernameLockoutFailedAttempts { get; set; }
        public TimeSpan forgottenUsernameLockoutDuration { get; set; }
        public int forgottenPasswordLockoutFailedAttempts { get; set; }
        public TimeSpan forgottenPasswordLockoutDuration { get; set; }
