...
namespace BrockAllen.MembershipReboot
{
    public class SecuritySettings : ConfigurationSection
    {
        ...
        private const string FORGOTTENUSERNAMELOCKOUTFAILEDATTEMPTS = "forgottenUsernameLockoutFailedAttempts";
        private const string FORGOTTENUSERNAMELOCKOUTDURATION = "forgottenUsernameLockoutDuration";
        private const string FORGOTTENPASSWORDLOCKOUTFAILEDATTEMPTS = "forgottenPasswordLockoutFailedAttempts";
        private const string FORGOTTENPASSWORDLOCKOUTDURATION = "forgottenPasswordLockoutDuration";
        ...
        [ConfigurationProperty(FORGOTTENUSERNAMELOCKOUTFAILEDATTEMPTS, DefaultValue = MembershipRebootConstants.SecuritySettingDefaults.forgottenUsernameLockoutFailedAttempts)]
        public int forgottenUsernameLockoutFailedAttempts
        {
            get { return (int)this[FORGOTTENUSERNAMELOCKOUTFAILEDATTEMPTS]; }
            set { this[FORGOTTENUSERNAMELOCKOUTFAILEDATTEMPTS] = value; }
        }

        [ConfigurationProperty(FORGOTTENUSERNAMELOCKOUTDURATION, DefaultValue = MembershipRebootConstants.SecuritySettingDefaults.forgottenUsernameLockoutDuration)]
        public TimeSpan forgottenUsernameLockoutDuration
        {
            get { return (TimeSpan)this[FORGOTTENUSERNAMELOCKOUTDURATION]; }
            set { this[FORGOTTENUSERNAMELOCKOUTDURATION] = value; }
        }

        [ConfigurationProperty(FORGOTTENPASSWORDLOCKOUTFAILEDATTEMPTS, DefaultValue = MembershipRebootConstants.SecuritySettingDefaults.forgottenPasswordLockoutFailedAttempts)]
        public int forgottenPasswordLockoutFailedAttempts
        {
            get { return (int)this[FORGOTTENPASSWORDLOCKOUTFAILEDATTEMPTS]; }
            set { this[FORGOTTENPASSWORDLOCKOUTFAILEDATTEMPTS] = value; }
        }

        [ConfigurationProperty(FORGOTTENPASSWORDLOCKOUTDURATION, DefaultValue = MembershipRebootConstants.SecuritySettingDefaults.forgottenPasswordLockoutDuration)]
        public TimeSpan forgottenPasswordLockoutDuration
        {
            get { return (TimeSpan)this[FORGOTTENPASSWORDLOCKOUTDURATION]; }
            set { this[FORGOTTENPASSWORDLOCKOUTDURATION] = value; }
        }
