...
namespace Bec.TargetFramework.Services.Tasks
{
    /// <summary>
    /// Task service
    /// </summary>
    public partial class ScheduleTaskService : IScheduleTaskService
    {
        ...
        //#endregion
        public void DeleteTask(Framework.Domain.Tasks.ScheduleTask task)
        {
            throw new NotImplementedException();
        }

        public Framework.Domain.Tasks.ScheduleTask GetTaskById(int taskId)
        {
            throw new NotImplementedException();
        }

        public Framework.Domain.Tasks.ScheduleTask GetTaskByType(string type)
        {
            throw new NotImplementedException();
        }

        public IList<Framework.Domain.Tasks.ScheduleTask> GetAllTasks(bool showHidden = false)
        {
            throw new NotImplementedException();
        }

        public void InsertTask(Framework.Domain.Tasks.ScheduleTask task)
        {
            throw new NotImplementedException();
        }

        public void UpdateTask(Framework.Domain.Tasks.ScheduleTask task)
        {
            throw new NotImplementedException();
        }
    }
