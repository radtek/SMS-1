...
{
    public class OfficialSearchWholeWithPriorityEngine21 : LRServiceEngineBase
    {
        private int m_ResponseTypeCode;

        public OfficialSearchWholeWithPriorityEngine21(ILogger logger)
            : base(logger)
        {
        ...
        {
            var request = ServiceDefinition.CreateAndInitialiseRequest(objectDictionary) as RequestOfficialSearchOfWholeWithPriorityV2_1Type;
        ...
        {
            var client = ServiceDefinition.ServiceClient as OfficialSearchWholeWithPriority21.OfficialSearchV2_1ServiceClient; ;
        ...
        {
            var client = ServiceDefinition.ServiceClient as OfficialSearchWholeWithPriority21.OfficialSearchV2_1ServiceClient; ;
            var request = ServiceDefinition.ServiceRequest as RequestOfficialSearchOfWholeWithPriorityV2_1Type;

            ServiceDefinition.ServiceResponse = client.processOS1Request(request);
        }

        private void CreateServiceResponseStatus()
        {
            var response = ServiceDefinition.ServiceResponse as OfficialSearchWholeWithPriority21.ResponseOfficialSearchOfWholeWithPriorityV2_0Type;
