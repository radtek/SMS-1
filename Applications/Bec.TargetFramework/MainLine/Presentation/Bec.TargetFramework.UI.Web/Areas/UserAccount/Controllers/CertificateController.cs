...
{
    [Authorize]
    public class CertificateController : ApplicationControllerBase
    {
        UserAccountService userAccountService;

        public CertificateController(UserAccountService userAccountService,ILogger logger) :  base(logger)
        {
