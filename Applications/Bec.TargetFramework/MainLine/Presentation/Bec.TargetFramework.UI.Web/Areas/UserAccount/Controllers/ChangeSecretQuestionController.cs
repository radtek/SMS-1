...
{
    [Authorize]
    public class ChangeSecretQuestionController : ApplicationControllerBase
    {
        UserAccountService userAccountService;
        public ChangeSecretQuestionController(UserAccountService userAccountService, ILogger logger)
            : base(logger)
        {
