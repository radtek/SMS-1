    ...
    ajaxWrapper({
        ...
        type: 'POST'
            ...
            .done(function (result) {
                ...
                $('#saveOrderStatus').css('display', 'inline-block').fadeIn(1000).delay(5000).fadeOut(1000);
            })
            .fail(function (err) {
    ...
    ajaxWrapper({
        ...
        type: 'POST'
            ...
            .done(function (result) {
                ...
                $('#saveOrderStatus2').css('display', 'inline-block').fadeIn(1000).delay(5000).fadeOut(1000);
            })
            .fail(function (err) {
                if (!hasRedirect(err.responseJSON)) self.lookupFailed();
            });
...
$(function () {
    ...
    var forSystemGrid = new gridItem(
        {
        ...
        .then(function (result) {
            ...
            $('#ItemList').sortable({
                ...
                change: function (event, ui) {
                    ...
                    //$('#saveOrderStatus').css('display', 'none').fadeOut(1000);
                },
                update: function (event, ui) {
                    $('#ItemList li').removeClass('highlights');
                    var start_index = ui.item.data('start_index');
                    var end_index = ui.item.data('end_index');
