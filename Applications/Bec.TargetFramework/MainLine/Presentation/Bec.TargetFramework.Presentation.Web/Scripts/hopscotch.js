  ...
  Hopscotch = function(initOptions) {
    ...
    this.endTour = function(clearState, doCallbacks) {
      ...
      cookieTourStep = undefined;
                ...
                // execute onNext callback in case of operations pending
      if ((currentStep !== null && currentStep.onBindTarget) != null)
          utils.invokeEventCallbacks('next', currentStep.onNext);
    ...
    _configure = function(options, isTourOptions) {
      var bubble,
          events = ['next', 'prev', 'start', 'end', 'show', 'error', 'close','bindTarget'],
          eventPropName,
          callbackProp,
          i,
          len;
