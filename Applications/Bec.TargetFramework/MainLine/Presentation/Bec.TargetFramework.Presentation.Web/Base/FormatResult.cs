...
namespace Bec.TargetFramework.UI.Process.Base
{
    public class FormatResult : ActionResult
    {
        ...
        private readonly Action<FormatCollection> _format;
        private readonly FormatCollection _formatCollection = new FormatCollection();
        ...
        {
            this._format(this._formatCollection);
        ...
        {
            this._format(this._formatCollection);
            return new ActionResultExposer(this._formatCollection);
        }
    }
}