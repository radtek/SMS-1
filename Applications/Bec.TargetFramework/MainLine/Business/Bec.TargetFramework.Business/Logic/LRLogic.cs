...
{
    public class LRLogic : LogicBase , ILRLogic
    {
        private IClassificationDataLogic m_ClassificationLogic;

        public LRLogic(ILogger logger, ICacheProvider cacheProvider, IClassificationDataLogic dataLogic)
        ...
        public void SaveLRTitleList(Guid stsPropertyId, Guid productPurchaseProductTaskID, Guid? stsSearchPropertyId, List<LRTitleDTO> dtoList)
        {
                    ...
                    true))
            {
                dtoList.ForEach(item =>
                {
                    var title = LRTitleConverter.ToEntity(item);
                    ...
                    {
                        var address = AddressConverter.ToEntity(item.Address);
