...
namespace Bec.TargetFramework.Business.Logic
{
    ...
    public class OrganisationLogicController : LogicBase
    {
        ...
        private async Task PublishBankAccountMarkedAsFraudSuspiciousNotification(VOrganisationBankAccountsWithStatusDTO bankAccount, OrganisationBankAccountStateChangeDTO bankAccountStatusChangeRequest)
        {
