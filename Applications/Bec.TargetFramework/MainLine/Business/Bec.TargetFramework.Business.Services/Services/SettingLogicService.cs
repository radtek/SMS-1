...
namespace Bec.TargetFramework.Business.Services
{
    ...
    public class SettingLogicService : SettingLogic, ISettingLogic, IBusinessLogicService
    {
        public SettingLogicService(ILogger logger, ICacheProvider cacheProvider) 
