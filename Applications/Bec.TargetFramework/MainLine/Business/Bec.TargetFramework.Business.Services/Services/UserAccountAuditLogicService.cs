...
namespace Bec.TargetFramework.Business.Services
{
    ...
    public class UserAccountAuditLogicService : UserAccountAuditLogic, IUserAccountAuditLogic, IBusinessLogicService
    {
        public UserAccountAuditLogicService( ILogger logger, ICacheProvider cacheProvider) 
