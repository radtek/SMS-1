...
namespace Bec.TargetFramework.Business.Services
{
    ...
    public class LRLogicService : LRLogic, ILRLogic, IBusinessLogicService
    {
        public LRLogicService(ILogger logger, ICacheProvider cacheProvider, IClassificationDataLogic cLogic)
