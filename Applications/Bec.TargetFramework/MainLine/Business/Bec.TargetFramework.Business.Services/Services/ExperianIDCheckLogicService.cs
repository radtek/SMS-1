...
namespace Bec.TargetFramework.Business.Services
{
    ...
    public class ExperianIDCheckLogicService : ExperianIDCheckLogic, IExperianIDCheckLogic, IBusinessLogicService
    {
        public ExperianIDCheckLogicService(ILogger logger, ICacheProvider cacheProvider, ExperianIDCheckSettings settings) 
