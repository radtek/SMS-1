...
namespace Bec.TargetFramework.Business.Services
{
    ...
    public class ExperianBWALogicService : ExperianBWALogic, IExperianBWALogic, IBusinessLogicService
    {
        public ExperianBWALogicService(ILogger logger, ICacheProvider cacheProvider, ExperianIDCheckSettings settings) 
