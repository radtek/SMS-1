...
namespace Bec.TargetFramework.Business.Services
{
    ...
    public class ResourceLogicService : ResourceLogic, IResourceLogic, IBusinessLogicService
    {
        public ResourceLogicService(ILogger logger, ICacheProvider cacheProvider) 
