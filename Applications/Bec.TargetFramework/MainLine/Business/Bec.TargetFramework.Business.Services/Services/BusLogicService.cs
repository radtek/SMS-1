...
namespace Bec.TargetFramework.Business.Services
{
    ...
    public class BusLogicService : BusLogic, IBusLogic, IBusinessLogicService
    {
        public BusLogicService(ILogger logger, ICacheProvider cacheProvider,IClassificationDataLogic  cLogic)
