...
namespace Bec.TargetFramework.Business.Services
{
    ...
    public class ValidationLogicService : ValidationLogic, IValidationLogic, IBusinessLogicService
    {
        public ValidationLogicService(ILogger logger, ICacheProvider cacheProvider)
