...
namespace Bec.TargetFramework.Business.Services
{
    ...
    public class OperationLogicService : OperationLogic, IOperationLogic, IBusinessLogicService
    {
        public OperationLogicService(ILogger logger, ICacheProvider cacheProvider) 
