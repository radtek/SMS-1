            ...
            try
            {
                ...
                if (!m_NotificationConstructDto.DefaultNotificationDeliveryMethodID.GetValueOrDefault(0).Equals(NotificationDeliveryMethodIDEnum.Email.GetIntValue()))
                {
                    try
                    {
                        ...
                        m_NotificationLogic.SaveNotificationConversation(m_NotificationContainerDto.ActivityID, m_NotificationContainerDto.ActivityType, null, true, notificationDto);
