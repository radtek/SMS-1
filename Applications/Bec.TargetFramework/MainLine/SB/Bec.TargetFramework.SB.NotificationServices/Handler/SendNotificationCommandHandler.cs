...
namespace Bec.TargetFramework.SB.NotificationServices.Handler
{
    ...
    public class SendNotificationCommandHandler : ConcurrentBaseHandler<SendNotificationCommand>
    {
        ...
        public SendNotificationCommandHandler(ILogger logger, INotificationLogic notifLogic,
            IBusLogic busLogic,IClassificationDataLogic dataLogic,IUserLogic uLogic,
        ...
        private byte[] GetReportData()
        {
            ...
            var reportGenerator = NotificationService.m_IocContainer.Resolve<StandaloneReportGenerator>();
        ...
        public override void HandleMessage(SendNotificationCommand command)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (recipientAddresses.Count > 0 && m_NotificationContainerDto.NotificationSetting.ExportFormat.HasValue && m_NotificationContainerDto.NotificationSetting.ExportFormat.Value == NotificationExportFormatIDEnum.HTML.GetIntValue())
                    {
                        ...
                        message.Sender = new MailAddress(m_CommonSettings.NotificationFromEmailAddress);
        ...
        private List<MailAddress> GetReceiptAddresses(NotificationDTO notificationDto)
        {
            ...
            // get emailaddresses
            var emailAddresses = m_NotificationLogic.GetRecipientAddressDetails(notificationDto.NotificationRecipients);
