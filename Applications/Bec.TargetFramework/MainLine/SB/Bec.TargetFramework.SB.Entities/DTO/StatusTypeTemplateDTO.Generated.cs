...
namespace Bec.TargetFramework.SB.Entities
{
    ...
    public partial class StatusTypeTemplateDTO
    {
        ...
        public StatusTypeTemplateDTO(global::System.Guid statusTypeTemplateID, int statusTypeTemplateVersionNumber, string name, string description, bool isActive, bool isDeleted, List<StatusTypeDTO> statusTypes, List<StatusTypeValueTemplateDTO> statusTypeValueTemplates, List<StatusTypeStructureTemplateDTO> statusTypeStructureTemplates) {
