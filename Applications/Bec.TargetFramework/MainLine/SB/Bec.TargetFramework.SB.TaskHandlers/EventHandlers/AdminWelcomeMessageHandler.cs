...
{
    public class AdminWelcomeMessageHandler : BaseEventHandler<AdminWelcomeMessageEvent>
    {
        public INotificationLogicClient m_nLogic { get; set; }
        public ITFSettingsLogicClient SettingsClient { get; set; }

        public override void HandleMessage(AdminWelcomeMessageEvent handlerEvent)
        {
            try
            {
                var notificationConstruct = m_nLogic.GetLatestNotificationConstructIdFromName("AdminWelcomeMessage");

                var dictionary = new ConcurrentDictionary<string, object>();
                dictionary.TryAdd("AdminWelcomeMessageDTO", handlerEvent.AdminWelcomeMessageDTO);
