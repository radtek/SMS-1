...
namespace Bec.TargetFramework.Web.Framework.Helpers
{
    public class WebUserHelper
    {
        ...
        public static WebUserObject GetWebUserObject(HttpContextBase context)
        {
            ...
            Ensure.Argument.NotNull(context.Session[m_WEBUSEROBJECTSESSIONKEY], "WebUser doesn't exist");

            var userObject = context.Session[m_WEBUSEROBJECTSESSIONKEY] as WebUserObject;
