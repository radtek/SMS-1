...
{
    public class TargetFrameworkModelBinder : DefaultModelBinder
    {
        public override object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            var model = base.BindModel(controllerContext, bindingContext);
            if (model is BaseTargetFrameworkModel) ((BaseTargetFrameworkModel) model).BindModel(controllerContext, bindingContext);
            return model;
        }
